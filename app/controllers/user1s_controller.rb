  ...
  def create
    ...
    respond_to do |format|
      if @user1.save
        ...
        format.html { redirect_to user1_url(@user1), notice: "User1 was successfully created." }
  ...
  def update
    respond_to do |format|
      if @user1.update(user1_params)
        format.html { redirect_to user1_url(@user1), notice: "User1 was successfully updated." }
